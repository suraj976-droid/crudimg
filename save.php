<?php
    ...
    if(isset($_POST['add-btn'])){
        ...
        $add_sql = "INSERt INTO `Student` (`email`,`pwd`,`image_name`) VALUES ('$email', '$pwd','$imageName')";
    ...
    if (isset($_POST['upd-btn'])) {
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            $upd_sql = "UPDATE `Student` SET `email`='$email', `pwd`='$pwd', `image_name`='$imageName' WHERE id=$id";
        } else {
